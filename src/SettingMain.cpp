...
const long SettingDialog::ID_CHOICE1 = wxNewId();
const long SettingDialog::ID_STATICTEXT2 = wxNewId();
const long SettingDialog::ID_CHOICE2 = wxNewId();
const long SettingDialog::ID_CHOICE3 = wxNewId();
const long SettingDialog::ID_CHOICE4 = wxNewId();
const long SettingDialog::ID_CHOICE5 = wxNewId();
const long SettingDialog::ID_STATICTEXT3 = wxNewId();
const long SettingDialog::ID_CHOICE6 = wxNewId();
const long SettingDialog::ID_STATICTEXT4 = wxNewId();
const long SettingDialog::ID_CHECKBOX1 = wxNewId();
const long SettingDialog::ID_CHECKBOX2 = wxNewId();
const long SettingDialog::ID_CHECKBOX3 = wxNewId();
...
const long SettingDialog::ID_CHOICE7 = wxNewId();
...
const long SettingDialog::ID_CHOICE8 = wxNewId();
BEGIN_EVENT_TABLE(SettingDialog,wxDialog)
    //(*EventTable(SettingDialog)
    //*)
    EVT_BUTTON(wxID_OK,SettingDialog::OnButton1Click)
END_EVENT_TABLE()

SettingDialog::SettingDialog(wxWindow* parent,SettingsMoni &Setting,wxWindowID id)
{
    ...
    ShowPreConfig(Setting);

    Connect(ID_BUTTON1,wxEVT_COMMAND_BUTTON_CLICKED,(wxObjectEventFunction)&SettingDialog::OnButton1Click);
    Connect(ID_BUTTON2,wxEVT_COMMAND_BUTTON_CLICKED,(wxObjectEventFunction)&SettingDialog::OnButton2Click);
    Connect(ID_BUTTON3,wxEVT_COMMAND_BUTTON_CLICKED,(wxObjectEventFunction)&SettingDialog::OnButton3Click);
}
...
void SettingDialog::ShowPreConfig(SettingsMoni PreConfig){

    //显示配置
    Choice1->SetSelection(Choice1->Append(PreConfig.vm_os));
...
void SettingDialog::OnButton1Click(wxCommandEvent& event)
{
	//获取当前配置
	//SettingsMoni TempSetting;
    //NewConfig.vm_os = Choice1->GetString(Choice1->GetSelection());
    TempSetting->tm_monitoring.tm_year = Choice7->GetSelection()+2017;
    TempSetting->tm_monitoring.tm_mon = Choice2->GetSelection();
    TempSetting->tm_monitoring.tm_mday= Choice3->GetSelection();
    TempSetting->tm_monitoring.tm_hour = Choice4->GetSelection();
    TempSetting->tm_monitoring.tm_min = Choice5->GetSelection();
    TempSetting->tm_monitoring.tm_sec = Choice8->GetSelection();
    TempSetting->repeat = (MonitorRepeatType)(Choice6->GetSelection()+1);
    TempSetting->os_ds_process = CheckBox1->GetValue();
    TempSetting->os_ds_module = CheckBox2->GetValue();
    TempSetting->os_ds_file = CheckBox3->GetValue();
    TempSetting->path = TextCtrl1->GetLineText(0);
    Close();
}

void SettingDialog::OnButton2Click(wxCommandEvent& event)
{
    Close();
}

void SettingDialog::OnButton3Click(wxCommandEvent& event)
{
